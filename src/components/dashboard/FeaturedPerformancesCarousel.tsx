                ...
                <div className="relative z-10 flex flex-col h-full">
                  ...
                  <div className="mt-auto pt-4">
                    <Link href={rateUrl} className="block">
                      <div 
                        className="w-full px-8 py-4 rounded-full text-black text-base font-bold tracking-wider uppercase transition-all duration-200 hover:scale-105 text-center cursor-pointer"
                        style={{

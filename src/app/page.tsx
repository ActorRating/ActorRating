...
export const metadata: Metadata = {
  ...
  description: "Rate and analyze acting performances using Oscar-inspired criteria. Join our community-driven platform to discover acclaimed performances from cinema history.",
  keywords: [

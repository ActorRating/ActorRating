...
export const metadata: Metadata = {
  ...
  description:
    "Rate and analyze acting performances using Oscar-inspired criteria. Join our community-driven platform to discover and explore acclaimed performances from cinema history.",
  keywords: [
    "actor rating",
    "actors rating",
    "rate acting",

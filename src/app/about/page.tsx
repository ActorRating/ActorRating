...
import {
  FaStar, FaChartLine, FaArrowRight, FaTheaterMasks,
  FaHeart, FaBolt, FaEye, FaHandshake, FaUsers, FaFilm,
} from "react-icons/fa";
...
const jsonLd = {
  ...
  description: "ActorRating: 570K+ performances, 208K+ actors. Rate with a quick slider or 5 criteria. We evaluate acting performances, not overall films.",
  publisher: {
    "@type": "Organization",
    name: "ActorRating",
...
export default function AboutPage() {
  const criteria = [
    { icon: FaHeart,       title: "Emotional Range & Depth",         description: "Does the actor access and convey a full spectrum of emotion? Can they hold grief, joy, rage, and tenderness simultaneously?" },
    { icon: FaTheaterMasks, title: "Character Believability",        description: "Do you forget you're watching an actor? The best performances make the character feel like a real person, not a performance." },
    { icon: FaBolt,        title: "Technical Skill & Authenticity",  description: "Voice, physicality, accent, movement — the craft beneath the surface. Mastery that serves the character, not the actor's ego." },
    { icon: FaEye,         title: "Screen Presence & Impact",        description: "The ineffable quality of commanding the frame. Some actors hold your attention even when standing still." },
    { icon: FaHandshake,   title: "Chemistry & Interaction",         description: "Great performances are often defined by how an actor elevates those around them. The ensemble dimension of the craft." },
  ];
        ...
        <div className="min-h-screen bg-black w-full" style={{ maxWidth: '100vw', overflowX: 'hidden' }}>
          ...
          >
            ...
            >
              ...
              >
                Rate the{' '}
                <span style={{ ...GOLD_TEXT, filter: 'drop-shadow(0 0 40px rgba(255,215,0,0.35))' }}>
                  Acting
                </span>
              </h1>
              ...
              <p className="text-base sm:text-lg md:text-xl text-[#a0a0a0] font-light leading-relaxed max-w-2xl mx-auto mt-2">
                The world&apos;s leading platform to rate, rank, and celebrate the greatest acting performances in cinema history.
              </p>
            </motion.div>
            ...
            >
              ...
              >
                ...
                <div className="relative z-10 space-y-5 max-w-2xl mx-auto">
                  ...
                  <p className="text-lg sm:text-xl md:text-2xl font-bold pt-2" style={GOLD_TEXT}>
            ...
            >
              ...
              >
                <div className="grid grid-cols-2 sm:grid-cols-4">
                  {stats.map((s, i) => (
                    <div key={i} className="relative flex flex-col items-center justify-center py-8 sm:py-10">
                      {i > 0 && (
                        <div className="absolute left-0 top-[20%] h-[60%] w-px" style={{ background: 'rgba(255,215,0,0.1)' }} />
                      )}
                      <span className="text-2xl sm:text-3xl md:text-4xl font-extrabold mb-1.5" style={GOLD_TEXT}>{s.value}</span>
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="text-center mb-8 sm:mb-10">
                    <p className="text-[10px] sm:text-xs font-bold tracking-[0.25em] uppercase text-[#FFD700] opacity-60 mb-3">Our Difference</p>
                    <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-2" style={CINZEL}>
                      Why This{' '}
                      <span style={GOLD_TEXT}>Matters</span>
                    </h2>
                    <GoldDivider width={120} />
                    <div className="mt-4 text-center">
                      <p className="text-lg sm:text-xl md:text-2xl text-[#e4e4e7] font-light mb-2">
                        Most platforms rate <span className="line-through opacity-30">movies</span>
                      </p>
                      <p className="text-lg sm:text-xl md:text-2xl font-semibold" style={GOLD_TEXT}>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {whyPoints.map((point, i) => (
                      ...
                      >
                        <span className="flex-shrink-0 w-2 h-2 rounded-full bg-[#FFD700] mt-2" style={{ boxShadow: '0 0 8px rgba(255,215,0,0.5)' }} />
                        <p className="text-sm sm:text-base text-[#e4e4e7] font-light leading-relaxed">{point}</p>
                      </div>
                    ))}
                  </div>
                </div>
            ...
            >
              <div className="text-center mb-8 sm:mb-10">
                <p className="text-[10px] sm:text-xs font-bold tracking-[0.25em] uppercase text-[#FFD700] opacity-60 mb-3">Simple Process</p>
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-2" style={CINZEL}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                {[
                  { icon: FaTheaterMasks, label: "01", title: "Select",  desc: "Choose any actor's role in a specific film from our database of 570K+ performances." },
                  { icon: FaStar,         label: "02", title: "Rate",    desc: "Use the quick single-slider or score across five Oscar-inspired criteria. Takes 2 minutes." },
                  { icon: FaChartLine,    label: "03", title: "Compare", desc: "See how your rating compares to the community. Explore actor career trajectories." },
                ].map((step, i) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="relative z-10">
                        <div className="inline-flex items-center px-3 py-1 rounded-full text-xs font-bold tracking-[0.2em] mb-5"
                          style={{ color: '#FFD700', background: 'rgba(255,215,0,0.1)', border: '1px solid rgba(255,215,0,0.25)' }}>
                          {step.label}
                        </div>
                        <div className="w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-5"
                          style={{ background: 'rgba(255,215,0,0.08)', border: '2px solid rgba(255,215,0,0.25)', boxShadow: '0 0 24px rgba(255,215,0,0.1)' }}>
                          <Icon className="w-7 h-7 text-[#FFD700]" />
                        </div>
                        <h3 className="text-xl font-bold text-white mb-3" style={CINZEL}>{step.title}</h3>
            ...
            >
              <div className="text-center mb-8 sm:mb-10">
                <p className="text-[10px] sm:text-xs font-bold tracking-[0.25em] uppercase text-[#FFD700] opacity-60 mb-3">Rating System</p>
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-2" style={CINZEL}>
                  The <span style={GOLD_TEXT}>5 Dimensions</span>
                </h2>
                <GoldDivider width={100} />
                <p className="text-sm sm:text-base text-[#888] max-w-xl mx-auto mt-4">
                  Rate with a quick single slider, or dive into all five Oscar-inspired criteria for a comprehensive assessment.
                </p>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                {criteria.map((c, i) => {
                  ...
                  return (
                    <div
                      key={i}
                      className={`group relative p-7 sm:p-8 rounded-[2rem] overflow-hidden transition-all duration-300 hover:shadow-[0_0_30px_rgba(255,215,0,0.1)] ${isLast ? 'sm:col-span-2 lg:max-w-lg lg:mx-auto lg:w-full' : ''}`}
                      style={{ background: CARD_BG, boxShadow: CARD_SHADOW }}
                    >
                      <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-[2rem] overflow-hidden pointer-events-none">
                      ...
                      <div className="relative z-10 flex items-start gap-5">
                        <div className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0"
                          style={{ background: 'rgba(255,215,0,0.08)', border: '2px solid rgba(255,215,0,0.25)' }}>
                          <Icon className="w-5 h-5 text-[#FFD700]" />
                        </div>
                        <div>
                          <div className="flex items-center gap-2 mb-2">
                            <span className="text-[10px] font-bold tracking-[0.2em] text-[#FFD700] opacity-60">0{i + 1}</span>
                            <h3 className="text-base sm:text-lg font-bold text-white" style={CINZEL}>{c.title}</h3>
                          </div>
                          <p className="text-sm text-[#888] leading-relaxed">{c.description}</p>
                        </div>
                      </div>
            ...
            >
              <div className="text-center mb-8">
                <p className="text-[10px] sm:text-xs font-bold tracking-[0.25em] uppercase text-[#FFD700] opacity-60 mb-3">Questions</p>
                <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-2" style={CINZEL}>
              ...
              <div className="space-y-4">
                {[
                  { q: "Are ratings based on movies or performances?", a: "Ratings are based on individual acting performances, not the overall movie. A single film may have multiple performance ratings — one for each actor in a significant role. This lets great performances shine even in mediocre films, and vice versa." },
                  { q: "Who can submit ratings?", a: "Anyone can create a free account and start rating. Our community-driven approach ensures diverse perspectives while standardized criteria maintain consistency across all ratings." },
                  { q: "How does the scoring work?", a: "You can rate with a quick single slider (0–10) or across five criteria scored 0–100 each. Multi-criteria scores are normalized and averaged into a final 0–10 performance score, then aggregated with community ratings." },
                  { q: "How is bias reduced?", a: "Through standardized criteria, community aggregation, and anonymous rating — so an actor's fame doesn't inflate their score. The focus on specific performance qualities rather than overall popularity helps surface overlooked work." },
                ].map((item, i) => (
                  <div
                    key={i}
                    ...
                    style={{ background: CARD_BG, boxShadow: CARD_SHADOW }}
                  >
                    <h3 className="text-base sm:text-lg font-bold text-white mb-3" style={CINZEL}>{item.q}</h3>
                    <p className="text-sm sm:text-base text-[#a0a0a0] leading-relaxed">{item.a}</p>
                  </div>
                ))}
              </div>
            </motion.section>
            ...
            >
              ...
              >
                ...
                <div className="relative z-10">
                  <p className="text-[10px] sm:text-xs font-bold tracking-[0.35em] uppercase text-[#FFD700] opacity-60 mb-5">Get Started</p>
                  <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-6" style={CINZEL}>
                    Ready to{' '}
                    <span style={GOLD_TEXT}>Start?</span>
                  </h2>
                  <GoldDivider width={100} />
                  <p className="text-base sm:text-lg md:text-xl text-[#a0a0a0] font-light mb-10 leading-relaxed max-w-lg mx-auto mt-4">
                    Join the community and start rating performances. It&apos;s free, forever.
                  </p>

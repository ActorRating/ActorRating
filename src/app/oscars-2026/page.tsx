    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="relative pt-32 pb-20 px-4">
        <div className="relative max-w-6xl mx-auto text-center">
          ...
          >
            Rate the performances. Not the films.
          </motion.p>
            ...
            >
              ...
              <div className="space-y-4 max-w-3xl mx-auto">
                {category.nominees.map((nominee, nomIndex) => {
                  ...
                  const href = hasData
                    ? `/rate/${perfData.movieSlug}/${perfData.actorSlug}`
                    : `/search?q=${encodeURIComponent(nominee.name)}`
                  ...
                  return (
                    ...
                    >
                      <Link href={href}>
                        <div
                          className="group relative p-6 rounded-2xl border border-transparent bg-gradient-to-br from-[#1a1a1a]/95 via-[#0f0f0f]/90 to-black/95 backdrop-blur-xl transition-all duration-300 hover:shadow-[0_0_30px_rgba(255,215,0,0.15)]"
                          style={{
                            boxShadow: `
                          ...
                          <div className="flex items-start justify-between gap-4">
                            ...
                            <div className="flex-shrink-0 flex flex-col items-end gap-2">
                              {hasData ? (
                                ...
                                <button
                                  className="px-6 py-2 rounded-full text-black text-sm font-bold transition-all duration-200 hover:scale-105"
                                  style={{

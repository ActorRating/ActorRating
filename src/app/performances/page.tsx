        ...
        <div className="relative z-10 flex flex-col h-full">
          ...
          <div className="mt-auto pt-4">
            <Link href={rateUrl} prefetch={false}>
              <button
                className="w-full px-6 py-4 sm:px-8 sm:py-4 rounded-full text-black text-base sm:text-base font-bold tracking-wider transition-all duration-200 hover:scale-105 cursor-pointer min-h-[56px] touch-manipulation"
                style={{
